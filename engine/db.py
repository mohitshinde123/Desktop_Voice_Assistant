...
con = sqlite3.connect("baba.db")
cursor = con.cursor()

#query = "CREATE TABLE IF NOT EXISTS sys_command(id integer primary key, name VARCHAR(100), path VARCHAR(1000))"
#cursor.execute(query)

# query = "INSERT INTO sys_command VALUES (null,'pycharm', 'C:\\Program Files\\JetBrains\\PyCharm Community Edition 2022.3.3\\bin\\pycharm64.exe')"
# cursor.execute(query)
# con.commit()
...
# query = "INSERT INTO contacts VALUES (null, 'Kunal', '8815982016', 'null')"
# cursor.execute(query)
# con.commit()
